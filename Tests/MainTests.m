...
centroidsAll = cat(1,centroids1{:});
figure;
isosurface(CTmatBi)
hold on
scatter3(centroidsAll(:,2),centroidsAll(:,3),centroidsAll(:,1),150,'MarkerFaceColor',[rand rand rand])
...
isosurface(CTmatBi)
hold on
scatter3(centroidsAll(:,3),centroidsAll(:,1),centroidsAll(:,2),150,'MarkerFaceColor',[rand rand rand])
...
isosurface(CTmatBi)
hold on
scatter3(centroidsAll(:,1),centroidsAll(:,3),centroidsAll(:,2),150,'MarkerFaceColor',[rand rand rand])
